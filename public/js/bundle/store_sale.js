...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
    ...
    }, _defineProperty(_ref, "timer", null), _defineProperty(_ref, "total", 0), _defineProperty(_ref, "GrandTotal", 0), _defineProperty(_ref, "units", []), _defineProperty(_ref, "services", []), _defineProperty(_ref, "search_service", ""), _defineProperty(_ref, "service_details", []), _defineProperty(_ref, "service_price", 0), _defineProperty(_ref, "product", {
      id: "",
      code: "",
      stock: "",
      quantity: 1,
      ...
      tax_method: "",
      product_variant_id: ""
    }), _defineProperty(_ref, "sumOfTransactions", ""), _defineProperty(_ref, "sumOfProduct", ""), _defineProperty(_ref, "total_detail", 0), _ref;
  },
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(["currentUser"])), {}, {
    ...
    sumOfTransactions: function sumOfTransactions() {
      return this.service_details.reduce(function (sum, transaction) {
  ...
  mounted: function mounted() {
    var _this2 = this;
    axios.get("Products/Warehouse/" + 1 + "?stock=" + 1).then(function (response) {
  ...
  methods: {
      ...
      if (value) {
        ...
        axios.get("services/" + id).then(function (response) {
          ...
          if (_this3.details.length > 0) {
            _this3.GrandTotal = _this3.sumOfTransactions + _this3.total_detail;
            _this3.service_price = _this3.sumOfTransactions + _this3.total_detail;
          } else {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__["loadStripe"])("".concat(_this4.stripe_key));
            case 2:
              _this4.stripe = _context.sent;
    ...
    ClickService: function ClickService(id) {
      ...
      axios.get("services/" + id).then(function (response) {
        ...
        var value = _this5.service_details.find(function (service_details) {
          return service_details.id == id;
        });
        if (value) {
          _this5.makeToast("warning", _this5.$t("AlreadyAdd"), _this5.$t("Warning"));
        } else {
          _this5.service_details.push(service_detail);
          _this5.service_price += service_detail.price;
          _this5.GrandTotal += service_detail.price;
        }
      });
    },
      ...
      if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
        this.timer = setTimeout(function () {
          var product_filter = _this10.products.filter(function (product) {
            return product.name === _this10.search_input;
          });
          if (product_filter.length === 1) {
            _this10.SearchProduct(product_filter[0]);
          } else {
            _this10.product_filter = _this10.products.filter(function (product) {
              return product.name.toLowerCase().startsWith(_this10.search_input.toLowerCase());
            });
          }
        }, 800);
      } else {
    ...
    add_product: function add_product() {
      ...
      var value = this.details.find(function (details) {
        return details.product_id == _this12.product.product_id;
      });
      if (value) {
        this.makeToast("warning", this.$t("AlreadyAdd"), this.$t("Warning"));
      } else {
      ...
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id == id) {
          if (detail.quantity - 1 > 0) {
            if (detail.quantity - 1 > detail.stock * this.details[i].product_qty) {
              this.makeToast("warning", this.$t("LowStock"), this.$t("Warning"));
            } else {
              this.formatNumber(this.details[i].quantity--, 2);
            }
    ...
    delete_Product_Detail: function delete_Product_Detail(id) {
      for (var i = 0; i < this.details.length; i++) {
        if (id === this.details[i].detail_id) {
          var subtotal = this.details[i].subtotal;
      ...
      if (this.verifiedForm()) {
        ...
        if (this.payment.Reglement == 'credit card') {
          ...
          axios.post("sales", {
            ...
            _this14.makeToast("success", _this14.$t("Create.TitleSale"), _this14.$t("Success"));
            nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
    ...
    Get_Product_Details: function Get_Product_Details(product_id) {
      ...
      axios.get("Products/" + product_id).then(function (response) {
        ...
        _this15.product.kh_name = response.data.kh_name;
        ...
        _this15.product.fix_price = response.data.fix_price;
        _this15.product.sale_unit_id = response.data.sale_unit_id;
        if (_this15.product.product_variant_id) {
          axios.get("ProductVarians/" + _this15.product.product_variant_id).then(function (response) {
            _this15.product.Net_price = response.data.price ? response.data.price : Net_price;
            _this15.product.ProductVariantQty = response.data.qty;
            _this15.product.Variant = response.data.name;
            _this15.product.product_qty = _this15.product.stock / response.data.qty;
            _this15.add_product();
            _this15.Calcul_Total();
          });
        } else {
          _this15.product.Net_price = Net_price;
          _this15.product.ProductVariantQty = _this15.product.stock;
          _this15.product.Variant = response.data.unitSale;
          _this15.product.product_qty = _this15.product.stock;
          _this15.add_product();
          _this15.Calcul_Total();
        }
      });
    ...
    GetElements: function GetElements() {
      ...
      axios.get("sales/create").then(function (response) {
        ...
        _this16.payment_terms = response.data.payment_terms;
        console.log(response.data.payment_terms);
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_c("h6", [_vm._v("Payment Term")]), _vm._v(" "), _c("v-select", {
    attrs: {
      reduce: function reduce(label) {
        return label.value;
      },
    ...
    }, [_vm._v("\n                            " + _vm._s(parseInt(detail.product_qty)) + " " + _vm._s(detail.Variant) + "\n                            ")])]), _vm._v(" "), _c("td", [_c("div", {
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader??ref--6-1!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--6-2!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css&");
...
/* empty/unused harmony star reexport *//* harmony import */ var _create_sale_vue_vue_type_style_index_0_id_e1ed42cc_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css& */ "./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css&");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_sale_vue_vue_type_style_index_0_id_e1ed42cc_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader!../../../../../../node_modules/css-loader??ref--6-1!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--6-2!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/src/views/app/pages/sales/create_sale.vue?vue&type=style&index=0&id=e1ed42cc&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_sale_vue_vue_type_style_index_0_id_e1ed42cc_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_sale_vue_vue_type_style_index_0_id_e1ed42cc_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_sale_vue_vue_type_style_index_0_id_e1ed42cc_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_create_sale_vue_vue_type_style_index_0_id_e1ed42cc_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
