      ...
      axios.get("Products/" + product_id).then(function (response) {
        ...
        if (_this6.product.product_variant_id) {
          axios.get("ProductVarians/" + _this6.product.product_variant_id).then(function (response) {
            _this6.product.Net_price = Net_cost * response.data.qty;
            _this6.product.product_variant_name = response.data.name;
            _this6.product.stock = _this6.product.stock / response.data.qty;
            console.log(_this6.product.unitSale);
            _this6.add_product();
            _this6.Calcul_Total();
          });
        } else {
          _this6.product.Net_price = Net_cost;
          _this6.product.product_variant_name = response.data.unitSale;
          _this6.add_product();
          _this6.Calcul_Total();
        }
      });
...
var render = function render() {
  ...
  return _c("div", {
    ...
    }, [_vm._v(_vm._s(parseInt(detail.stock)) + " " + _vm._s(detail.product_variant_name))])]), _vm._v(" "), _c("td", [_c("div", {
