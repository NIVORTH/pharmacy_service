  ...
  methods: {
    ...
    add_product: function add_product() {
      ...
      var value = this.details.find(function (details) {
        return details.product_id == _this7.product.product_id;
      });
      if (value) {
        this.makeToast("warning", this.$t("AlreadyAdd"), this.$t("Warning"));
      } else {
    ...
    Get_Product_Details: function Get_Product_Details(product_id) {
      ...
      axios.get("Products/" + product_id).then(function (response) {
        ...
        _this9.product.kh_name = response.data.kh_name;
        // this.product.Net_cost = response.data.Net_cost;
        var Net_cost = response.data.Net_cost;
        ...
        if (_this9.product.product_variant_id) {
          axios.get("ProductVarians/" + _this9.product.product_variant_id).then(function (response) {
            var New_Net_cost = Net_cost * response.data.qty;
            _this9.product.Net_cost = New_Net_cost ? New_Net_cost : Net_cost;
            _this9.product.product_stock = _this9.product.stock / response.data.qty;
            _this9.product.variant_name = response.data.name;
            _this9.add_product();
            _this9.Calcul_Total();
          });
        } else {
          var New_Net_cost = Net_cost;
          _this9.product.Net_cost = Net_cost;
          _this9.product.product_stock = _this9.product.stock;
          _this9.product.variant_name = response.data.unitSale;
          _this9.add_product();
          _this9.Calcul_Total();
        }
      });
