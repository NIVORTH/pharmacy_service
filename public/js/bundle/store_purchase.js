...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (this.purchase.warehouse_id != "" && this.purchase.warehouse_id != null) {
        this.timer = setTimeout(function () {
          var product_filter = _this4.products.filter(function (product) {
            return product.name === _this4.search_input || product.name.includes(_this4.search_input);
          });
          if (product_filter.length === 1) {
            _this4.SearchProduct(product_filter[0]);
          } else {
            _this4.product_filter = _this4.products.filter(function (product) {
              return product.name.toLowerCase().startsWith(_this4.search_input.toLowerCase())
    ...
    keyup_Cost: function keyup_Cost() {
    ...
    Get_Product_Details: function Get_Product_Details(product_id) {
      ...
      axios.get("Products/" + product_id).then(function (response) {
        ...
        _this7.product.kh_name = response.data.kh_name;
        ...
        if (_this7.product.product_variant_id) {
          axios.get("ProductVarians/" + _this7.product.product_variant_id).then(function (response) {
            ...
            _this7.product.product_stock = _this7.product.stock / response.data.qty;
            _this7.product.variant_name = response.data.name;
            _this7.add_product();
            _this7.Calcul_Total();
          });
        } else {
          ...
          _this7.product.product_stock = _this7.product.stock > 0 ? _this7.product.stock : 0;
          _this7.product.variant_name = response.data.unitSale;
          _this7.add_product();
          _this7.Calcul_Total();
        }
      });
  ...
  return _c("div", {
    ...
    return _c("tr", [_c("td", [_vm._v(_vm._s(detail.detail_id))]), _vm._v(" "), _c("td", [_c("span", [_vm._v(_vm._s(detail.name))]), _vm._v(" "), _c("i", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: detail.Net_cost,
        expression: "detail.Net_cost"
      }],
      ...
      on: {
        keyup: function keyup($event) {
          return _vm.keyup_Cost();
        },
        focus: _vm.handleFocus,
        blur: _vm.handleBlur,
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(detail, "Net_cost", $event.target.value);
        }
      }
    })]), _vm._v(" "), _c("td", [_c("span", {
      staticClass: "badge badge-outline-warning"
    }, [_vm._v(_vm._s(parseInt(detail.product_stock)) + " " + _vm._s(detail.variant_name))])]), _vm._v(" "), _c("td", [_c("div", {
