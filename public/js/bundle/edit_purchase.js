  ...
  methods: {
    ...
    Get_Product_Details: function Get_Product_Details(product_id) {
      ...
      axios.get("Products/" + product_id).then(function (response) {
        ...
        if (_this6.product.product_variant_id) {
          axios.get("ProductVarians/" + _this6.product.product_variant_id).then(function (response) {
            var New_Net_cost = Net_cost * response.data.qty;
            _this6.product.Net_cost = New_Net_cost ? New_Net_cost : Net_cost;
            _this6.product.product_variant_name = response.data.name;
            _this6.add_product();
            _this6.Calcul_Total();
          });
        } else {
          var New_Net_cost = Net_cost;
          _this6.product.Net_cost = New_Net_cost;
          _this6.product.product_variant_name = response.data.unitPurchase;
          _this6.add_product();
          _this6.Calcul_Total();
        }
      });
...
var render = function render() {
  ...
  return _c("div", {
    ...
    }, [_c("td", [_vm._v(_vm._s(detail.detail_id))]), _vm._v(" "), _c("td", [_vm._v("\n                          " + _vm._s(detail.name) + "\n                          "), _vm._v(" "), _c("i", {
      directives: [{
        name: "show",
        rawName: "v-show",
    ...
    }, [_vm._v(_vm._s(detail.stock) + " " + _vm._s(detail.product_variant_name))])]), _vm._v(" "), _c("td", [_c("div", {
