    ...
    <b-modal hide-footer size="sm" scrollable id="Show_invoice" :title="$t('Invoice_POS')">
      <div id="invoice-POS">
        <div style="max-width:500px;margin:0px auto">
          <div class="info">
            <h2 style="text-align:center; ">{{invoice_pos.setting.CompanyName}}</h2>
          </div>
          <div class="row">
            <div style="width: 53%; float: left">
              <div class="info">
                <p style="font-size: 12px;">
                  <span>Date {{invoice_pos.sale.date}}​ From:</span><br>
                  <!-- <span>Ref No: {{invoice_pos.sale.Ref}}</span>    -->
                </p>
                <h4>{{invoice_pos.setting.CompanyName}}</h4>
                <p style="font-size: 12px;">
                  ...
                  <!-- <div style="text-align:center; font-size: 10px;"><b><u>វិក្កយបត្រ</u></b></div>
                  <div style="text-align:center; font-size: 10px;"><b><u>Receipt</u></b></div>
                  <div style="font-size: 10px;">
                    <span>បេឡាករ: {{currentUser.username}}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span style="text-align:right;">លេខរៀងវិក្កយបត្រ: {{invoice_pos.sale.Ref}}</span>
                  </div>
                  <div style="font-size: 10px;">
                    អតិថិជន<span v-show="pos_settings.show_customer">: {{invoice_pos.sale.client_name}}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    កាលបរិច្ឆេទ<span>: {{invoice_pos.sale.date}}</span>
                  </div> -->
              </div>
            </div>
            ...
            <div style="width: 43%; float: right">
              <div class="info">
                ...
                <h4 v-show="pos_settings.show_customer">{{invoice_pos.sale.client_name}}</h4>
                <p style="font-size: 12px;">
                  <span>{{invoice_pos.sale.client_adr}}</span><br>
                  <span>{{$t('Phone')}} : {{invoice_pos.sale.client_tele}}</span><br>
                  <span>{{$t('Email')}} : {{invoice_pos.sale.client_email}}​</span><br>
                </p>
              </div>
            </div>
          </div><br><br><br><br><br><br><br><br><br><br><br>
          <div>
            <table border="1px solid" style="border-spacing: -0px;">
              <thead style="background-color: lightgray;">
                <tr>
                  <td style="width:40px; font-size: 13px; text-align:center;"><b>No</b></td>
                  <td style="width:250px; text-align:center; font-size: 13px;"><b>Description</b></td>
                  <td style="width:100px; text-align:center; font-size: 13px;"><b>Quantity</b></td>
                  <td style="width:110px; text-align:center; font-size: 13px;"><b>Unit Price</b></td>
                  <td style="width:120px; text-align:center; font-size: 13px;"><b>Subtotal</b></td>
                </tr>
              </thead>
              <tbody>
                <tr v-for="(detail_invoice, index) in invoice_pos.details">
                  <td style="width:40px; font-size: 12px; text-align:center;">
                    <div id="app">
                        {{ index +1}}
                    </div>
                  </td>
                  <td style="width:250px; font-size: 12px; text-align:center;" >
                  ...
                  <td style="width:110px; font-size: 12px; text-align:center;">
                    {{currentUser.currency}}{{formatNumber(detail_invoice.total/detail_invoice.quantity,2)}}
                  </td>
                  <td style="width:120px; font-size: 12px; text-align:center;">
                ...
                <tr style="margin-top:15px; font-size: 12px;">
                  <td colspan="4" class="total" style="text-align:right;">{{$t('TotalAmount')}} (USD)</td>
                  <td style="text-align:right;" class="total">{{currentUser.currency}}{{formatNumber(parseFloat(invoice_pos.sale.GrandTotal),2)}}</td>
                </tr>
                <tr style="margin-top:15px; font-size: 12px;">
                  <td colspan="4" class="total" style="text-align:right;">Today Rate: {{ totalriel }}, Total Amount (Riel)</td>
                  <td style="text-align:right;" class="total">{{formatNumber(invoice_pos.sale.GrandTotal * parseFloat(totalriel),2)}}</td>
                </tr>
                ...
                <tr v-show="invoice_pos.sale.paid_amount < invoice_pos.sale.GrandTotal" style="margin-top:15px; font-size: 12px;"> 
                  <td colspan="4" class="total" style="text-align:right;">{{$t('Balance')}} (USD)</td>
                  <td style="text-align:right;" class="total">
          ...
          <div id="legalcopy" class="ml-2">
            <div style="width: 48%; float: left; font-size: 12px;" >
              <div>
                <span>Seller: Heng Chor Pharmacy</span><br><br><br><br><br><br>
              </div>
              <span style="text-align: center;">Stamp & Signature</span>
            </div>
            <div style="width: 35%; float: right; font-size: 12px;">
              <div>
                <span>Customer: {{invoice_pos.sale.client_name}}</span><br><br><br><br><br><br>
              </div>
              <span style="text-align: center;">Stamp & Signature</span>
            </div>
    ...
    search(){
      ...
      if (this.sale.warehouse_id != "" &&  this.sale.warehouse_id != null) {
        this.timer = setTimeout(() => {
          const product_filter = this.products_pos.filter(product => product.name === this.search_input);
