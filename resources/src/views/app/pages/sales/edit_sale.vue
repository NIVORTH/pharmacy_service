                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr v-for="service_detail  in service_details">
                              ...
                              <td>{{currentUser.currency}}{{service_detail.price}}</td>
                              <td>
                                <a
                ...
                // service_detail['price'] = parseFloat(service_detail.price);              
                  let old_price = parseFloat(value.price);
                    ...
                    if(this.details.length > 0){
                      this.GrandTotal =  parseFloat(this.sumOfTransactions + this.total_detail);
                      this.service_price =  parseFloat(this.sumOfTransactions + this.total_detail);
                    }else{   
       ...
       axios.get("services/" + id).then(response => {
        ...
        let service_detail = response.data;
            ...
            if(value){
             ...
             this.service_details.push(service_detail);
              this.service_price += parseFloat(service_detail.price);
              this.GrandTotal += parseFloat(service_detail.price);
            }
