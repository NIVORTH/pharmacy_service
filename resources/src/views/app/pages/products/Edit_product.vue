              ...
              <b-card-body>
                <b-row>
                  ...
                  <b-col md="6" class="mb-2">
                    ...
                    <!-- Sub Category -->
                   <!-- <b-col md="6" class="mb-2">
                  <validation-provider name="subcategory" :rules="{ required: true}">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('SubCategorie')">
                      <v-select
                        :reduce="label => label.value"
                        :placeholder="$t('Choose_Category')"   
                        v-model="product.subcategory_id"                   
                        :options="subcategories.map(subcategories => ({label: subcategories.name, value: subcategories.id}))"
                      />
                      <b-form-invalid-feedback>{{ errors[0] }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
       ...
       axios
        ...
        .then(response => {
          ...
          // }else{
             ...
             console.log(this.product.subcategory_id );
          //      alert(2);
          // }
